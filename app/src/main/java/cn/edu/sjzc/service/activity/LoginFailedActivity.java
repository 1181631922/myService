...
import cn.edu.sjzc.service.breakpointthreaddownload.DownloadProgressListener;
import cn.edu.sjzc.service.breakpointthreaddownload.FileDownloader;
...
public class LoginFailedActivity extends BaseActivity {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (progressBar.getProgress() == progressBar.getMax()) {
                        Toast.makeText(LoginFailedActivity.this, R.string.success,
                                1).show();
                    }
                    break;
                case -1:
                    // 显示下载错误信息
                    Toast.makeText(LoginFailedActivity.this, R.string.error, 1)
                            .show();
                    break;
            }
        }
    ...
    private void initView() {
        ...
        Button button = (Button) this.findViewById(R.id.download_two);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Environment.getExternalStorageState().equals(
                    ...
                    // 显示SDCard错误信息
                    Toast.makeText(LoginFailedActivity.this,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                FileDownloader loader = new FileDownloader(
                        LoginFailedActivity.this, path, savedir, 3);
